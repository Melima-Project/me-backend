...
module.exports = function(Product) {
    ...
    Product.validateAsync('Price', validatePrice, {message: 'Price should be > 1'});
    ...
    Product.validatesLengthOf('SerialNumber', {min: 0, max: 20, message: {min: 'SerialNumber is too short', max: 'SerialNumber is too long'}});
